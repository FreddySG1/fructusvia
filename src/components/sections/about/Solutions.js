                    ...
                    <div className="row align-items-center ">
                        ...
                        <div className="col-lg-6 ">
                            <div className="section-title-wrap ">
                                <h2 className="col-lg-12 titl">Exhibición de frutas y verduras frescas</h2>
                                <p className="titlep">
                    ...
                    <div className="row align-items-center exportacion ">
                        ...
                        <div className="col-lg-6 title-ind ">
                            <div className="section-title-wrap industry">
                                <h2 className="col-lg-12 titI">Industria y exportación</h2>
                                <p className="titlep_first">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 title-camera">
                            <div className="section-title-wrap camera">
                                <h2 className="col-lg-12 titf">Cámara de refrigeración</h2>
                                <p className="titlep_second">
                ...
                <div className="row align-items-center exportaciones">
                    <div className="col-lg-6 title-envio">
                        <div className="section-title-wrap send">
                            <h2 className="col-lg-12 titE">Envío consolidado para comercializadoras</h2>
                            <p className="titlep_therd">
